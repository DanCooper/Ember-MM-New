            ...
            If iType = Enums.ImageType.Posters Then 'posters
                ...
                If Master.eSettings.UseImgCacheUpdaters Then
                    ...
                    Else
                        If AdvancedSettings.GetBooleanSetting("UseTMDB", True) Then
                            tmpListTMDB.AddRange(TMDB.GetTMDBImages(IMDBID, TMDBID, "poster"))
                        End If
                ...
                Else
                    If AdvancedSettings.GetBooleanSetting("UseTMDB", True) Then
                        ...
                        tmpListTMDB = TMDB.GetTMDBImages(IMDBID, TMDBID, "poster")
                ...
                If AdvancedSettings.GetBooleanSetting("UseTMDB", True) Then
                    ...
                    If Master.eSettings.UseImgCacheUpdaters Then
                        ...
                        Else
                            ...
                            tmpListTMDB = TMDB.GetTMDBImages(IMDBID, TMDBID, "backdrop")
...
foundIT:
    ...
    Public Sub GetPreferredFAasET(ByVal IMDBID As String, ByVal TMDBID As String, ByVal sPath As String)
        Dim _Image As Image
        'Dim TMDB As TMDB.Scraper
        Dim IMPA As New IMPA.Scraper
        Dim MPDB As New MPDB.Scraper
